...
import (
	...
	"github.com/AmoebaTeam/go-amoeba/internal/build"
	"github.com/AmoebaTeam/go-amoeba/params"
	sv "github.com/AmoebaTeam/go-amoeba/swarm/version"
)
...
func doInstall(cmdline []string) {
	...
	if !strings.Contains(runtime.Version(), "devel") {
		...
		if minor < 9 {
			...
			log.Println("go-amoeba requires at least Go version 1.9 and cannot")
...
type debMetadata struct {
	...
	// go-amoeba version being built. Note that this
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/AmoebaTeam/go-amoeba/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "--tags", "ios", "-v", "github.com/AmoebaTeam/go-amoeba/mobile")
