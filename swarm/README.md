...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/AmoebaTeam/go-amoeba

    go install github.com/AmoebaTeam/go-amoeba/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/AmoebaTeam/go-amoeba`.

Most likely you will be working from your fork of `go-amoeba`, let's say from `github.com/nirname/go-amoeba`. Clone or move your fork into the right place:

```
git clone git@github.com:nirname/go-amoeba.git $GOPATH/src/github.com/AmoebaTeam/go-amoeba
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/AmoebaTeam/go-amoeba/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/AmoebaTeam/go-amoeba/wiki/Code-Review-Guidelines).
