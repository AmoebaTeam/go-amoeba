...
//
// Detailed usage document and tutorial available on the go-amoeba Wiki page:
// https://github.com/AmoebaTeam/go-amoeba/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
